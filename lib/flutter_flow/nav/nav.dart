...
class AppStateNotifier extends ChangeNotifier {
  MarketplacedavaoFirebaseUser? initialUser;
  MarketplacedavaoFirebaseUser? user;
  ...
  void update(MarketplacedavaoFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'homePageMAIN')
                  : HomePageMAINWidget(),
            ),
            FFRoute(
              name: 'createAccount',
            ...
            FFRoute(
              name: 'PostProducts',
              path: 'postProducts',
              builder: (context, params) => PostProductsWidget(),
            )
